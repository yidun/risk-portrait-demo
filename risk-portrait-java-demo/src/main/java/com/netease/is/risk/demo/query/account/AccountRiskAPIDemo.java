...
package com.netease.is.risk.demo.query.account;
 ...
 * @author yidun
 */
public class AccountRiskAPIDemo {
    /**
     * 产品密钥ID，产品标识
     */
     ...
     * 接口地址
     */
    private final static String API_URL = "https://rp.dun.163.com/v1/profile/user/multiple/query";
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        accounts.add("123");
        accounts.add("123456");
        params.put("accounts", JSON.toJSONString(accounts));
        ...
        if (code == 200) {
            ...
            if (status) {
                System.out.printf("taskId=%s，账号风险画像获取成功%n", taskId);
            } else {
                System.out.printf("taskId=%s，账号风险画像获取失败%n", taskId);
            }
        } else {
            System.out.printf("账号风险画像获取失败，详情见接口文档说明，response=%s%n", jsonObject);
        }
    }
}
