...
package com.netease.is.risk.demo.query.phone;
...
public class PhoneRiskAPIDemo {
     ...
     * 接口地址
     */
    private final static String API_URL = "https://rp.dun.163.com/v1/profile/phone/multiple/query";
    /**
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (code == 200) {
            ...
            if (status) {
                System.out.printf("taskId=%s，手机号风险画像获取成功%n", taskId);
            } else {
                System.out.printf("taskId=%s，手机号风险画像获取失败%n", taskId);
            }
        } else {
            System.out.printf("手机号风险画像获取失败，详情见接口文档说明，response=%s%n", jsonObject);
        }
    }
}
